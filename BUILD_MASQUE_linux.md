...
cd ../<br>
## build ngtcp2<br>
sudo apt install libev-dev<br>
git clone https://github.com/ngtcp2/ngtcp2<br>
cd ngtcp2/<br>
autoreconf -fi<br>
./configure --prefix="path to install-ngtcp2" --enable-lib-only --with-openssl<br>
  OR (to enable debug)<br>
./configure --prefix="path to install-ngtcp2" --enable-lib-only --with-openssl --enable-debug<br>
sudo make<br>
sudo make install<br>
cd ../<br>
...
autoreconf -fi<br>
LDFLAGS="-Wl,-rpath,"path to install-openssl"/lib64 ./configure --prefix="path to install-curl" --with-openssl="path to install-openssl" --with-nghttp3="path to install-nghttp3" --with-ngtcp2="path to install-ngtcp2" --enable-debug<br>
sudo make<br>
sudo make install<br>
cd ../<br>
<br>
